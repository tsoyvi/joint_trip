<template>
    ...
    <button type="button" data-bs-toggle="modal" data-bs-target="#endTripModalWindow" style="display: none;"
        id="openButtonEndTripModalWindow">
    </button>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <div v-if="trip">
                        <div>Отправление из {{trip.from}} дата / время: {{ formatDateTimeToRus(trip.date_depart) }}
                        </div>
