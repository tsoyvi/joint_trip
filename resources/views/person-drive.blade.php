            ...
            <div class="personal-main">
                <div class="personal-main-menu">
                    <ul class="personal-main-menu-list">
                        ...
                        <li class="personal-main-menu-link active"><a href="personal-drive.blade.php" class="btm-go-main">Мои поездки</a></li>

                        <li class="personal-main-menu-link"><a href="personal-notice.blade.php" class="btm-go-main">Уведомления</a></li>
                    </ul>
                </div>
                <div class="personal-main-info">
                    ...
                    <div class="personal-drive-empty">
